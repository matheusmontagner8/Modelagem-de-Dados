...
| Item | Registro |
|---|---|
| **Ferramenta e etapa** | Claude (Claude Code / Sonnet 5, Anthropic) — usado em três momentos: (1) leitura do questionário de requisitos e construção do modelo conceitual (entidades, atributos, relacionamentos, cardinalidades) e do dicionário de dados; (2) geração do diagrama ER e exportação em PDF/PNG; (3) preenchimento deste README a partir do esqueleto oficial da Entrega 1. |
